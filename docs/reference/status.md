...
|---|---|---|
| Worked example | The full safety-benefit chain end-to-end on a single segment, from raw per-severity inputs through the optimization | Arithmetic matches the methodology document to the cent in Python and in all three solver-language formats (AMPL, GAMS, LP) |
