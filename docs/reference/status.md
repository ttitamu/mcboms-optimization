...
| Harwood (2003) at $50M | The optimization layer reproduces a published case study at the unconstrained budget | All reported costs and benefits match the Harwood (2003) published values within rounding; all ten site selections match exactly |
...
- **Corridor Condition Measures module** (energy, emissions, accessibility, resilience, pavement), with double-counting protocols against the operational benefit
...
Both items are scoped for follow-on work when the relevant data becomes available.
