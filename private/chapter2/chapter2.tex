% =====================================================================
% MCBOMs Task 4 Report
% Chapter 2: Updated Formulation of MCBOMs
%
% This file is a self-contained Overleaf-ready LaTeX document.
% To incorporate into the master report, copy content between the
% BEGIN CHAPTER and END CHAPTER markers.
%
...
%   - Citations use natural language (Author, Year) for now;
%     swap to \cite{key} when migrated to the master bibliography
%
% Date: April 24, 2026
...
% Section numbering: this is Chapter 2 of the report.
% In standalone mode, we present sections as Sections 2.1, 2.2, etc.
...
\title{MCBOMs Task 4 Report \\ \large Chapter 2: Updated Formulation of MCBOMs (Formulation and Validation)}
...
\section*{Chapter 2: Updated Formulation of MCBOMs}
\addcontentsline{toc}{section}{Chapter 2: Updated Formulation of MCBOMs}

The objective of Task~4 is to develop the network-level optimization model that
forms the analytical core of the Multidisciplinary Cost Benefit Optimization
Models (MCBOMs) framework. This chapter presents the updated mathematical
formulation, integrating safety, operational, and corridor condition benefits
within a Mixed-Integer Linear Programming (MILP) structure suitable for both
project-level and network-level investment decisions. The chapter then documents
the validation of the MCBOMs implementation against two published benchmarks:
Harwood et al.~(2003), who developed the Resurfacing Safety Resource
Allocation Program (RSRAP) for allocating resources to safety improvements
within Resurfacing, Restoration, and Rehabilitation (RRR) projects on
nonfreeway facilities, and Banihashemi~(2007), who developed a segment- and
intersection-level network optimization framework integrating safety and
...
optional constraints are documented in this chapter as supported by the
...
the methodology described in this chapter and that the framework default
...
chapter are reproducible from the project's GitHub repository. The
